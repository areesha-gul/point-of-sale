    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="card bg-orange-50 border-2 border-orange-200">
                    <h3 className="text-lg font-medium text-gray-700 mb-2">Expenses for Selected Month</h3>
                    <p className="text-3xl font-bold text-orange-700">
                ...
                <div className="card bg-red-50 border-2 border-red-200">
                    <h3 className="text-lg font-medium text-gray-700 mb-2">Total Expenses Overall</h3>
                    <p className="text-3xl font-bold text-red-700">
                        {formatIndianCurrency(kpis?.totalExpensesOverall || 0)}
                    </p>
                    <p className="text-sm text-gray-600 mt-1">All recorded business expenses</p>
                </div>
            </div>
